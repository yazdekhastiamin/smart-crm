...
// رنگ‌های خط/ناحیه‌ی نمودار روند — همیشه روی پنل Petrol Teal (تیره در هر دو
// تم) می‌نشیند، پس در هر دو تم به amber-tint نیاز دارد نه amber معمولی.
export const TREND_LINE_COLOR = "#e3a75c";

// چهار توکن اصلی برند/وضعیت که هر دو تم را با هم اعتبارسنجی می‌کنند — برای
// مرجع و تست؛ منبع واقعی رندر همان متغیرهای CSS در index.css هستند.
